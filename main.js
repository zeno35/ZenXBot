...
async function starts() {
    ...
    client.on('qr', () => {
        console.log(color('[QR]', 'red'), color('Scan to establish connection'));
    });
    ...
    link = 'https://chat.whatsapp.com/HjTXXKRjadi6M7xazopU9e' //id GroupWA
    ...
    client.on('group-participants-update', async(anu) => {
        ...
        if (isWelcome === true) {
            ...
            if (anu.action == 'add') {
                ...
                // client.adReply(mdata.id, capt, MessageType.text, 'Selamat datang member baru', 'Member ke ' + member + ' Group ' + mdata.subject, buff, '');
